...
class ClientHistoryAndInformation extends Component {
    ...
    updateFields() {
        ...
        infoObj.DateofBirthClient = fields["CHANGE"];
        infoObj.AgeClient = fields["CHANGE"];
        infoObj.ReferringDiagnosis = fields["CHANGE"];
        infoObj.CurrentHeightClient = fields["CHANGE"];
        infoObj.CurrentWeightClient = fields["CHANGE"];
        infoObj.StreetClient = fields["CHANGE"];
        infoObj.CityClient = fields["CHANGE"];
        infoObj.StateClient = fields["CHANGE"];
        infoObj.ZipCodeClient = fields["CHANGE"];
        infoObj.CountryClient = fields["CHANGE"];
        infoObj.HomePhoneClient = fields["CHANGE"];
        infoObj.NameMother = fields["CHANGE"];
        infoObj.CellPhoneMother = fields["CHANGE"];
        infoObj.EmailAddressMother = fields["CHANGE"];
        infoObj.AgeMother = fields["CHANGE"];
        infoObj.OccupationMother = fields["CHANGE"];
        infoObj.NameFather = fields["CHANGE"];
        infoObj.CellPhoneFather = fields["CHANGE"];
        infoObj.EmailAddressFather = fields["CHANGE"];
        infoObj.AgeFather = fields["CHANGE"];
        infoObj.OccupationFather = fields["CHANGE"];
        infoObj.MaritalStatus = fields["CHANGE"];
        infoObj.LegalGuardian = fields["CHANGE"];
        infoObj.NameStepMother = fields["CHANGE"];
        infoObj.CellPhoneStepMother = fields["CHANGE"];
        infoObj.EmailAddressStepMother = fields["CHANGE"];
        infoObj.AgeStepMother = fields["CHANGE"];
        infoObj.OccupationStepMother = fields["CHANGE"];
        infoObj.NameStepFather = fields["CHANGE"];
        infoObj.CellPhoneStepFather = fields["CHANGE"];
        infoObj.EmailAddressStepFather = fields["CHANGE"];
        infoObj.AgeStepFather = fields["CHANGE"];
        infoObj.OccupationStepFather = fields["CHANGE"];
        infoObj.IsAdopted = fields["CHANGE"];
        infoObj.AdoptionAge = fields["CHANGE"];
        infoObj.AdoptionCountryOfBirth = fields["CHANGE"];
        infoObj.NameSibling1 = fields["CHANGE"];
        infoObj.AgeSibling1 = fields["CHANGE"];
        infoObj.GenderSibling1 = fields["CHANGE"];
        infoObj.NameSibling2 = fields["CHANGE"];
        infoObj.AgeSibling2 = fields["CHANGE"];
        infoObj.GenderSibling2 = fields["CHANGE"];
        infoObj.NameSibling3 = fields["CHANGE"];
        infoObj.AgeSibling3 = fields["CHANGE"];
        infoObj.GenderSibling3 = fields["CHANGE"];
        infoObj.NameSibling4 = fields["CHANGE"];
        infoObj.AgeSibling4 = fields["CHANGE"];
        infoObj.GenderSibling4 = fields["CHANGE"];
        infoObj.NameSibling5 = fields["CHANGE"];
        infoObj.AgeSibling5 = fields["CHANGE"];
        infoObj.GenderSibling5 = fields["CHANGE"];
        infoObj.BirthWeeks = fields["CHANGE"];
        infoObj.BirthWeight = fields["CHANGE"];
        infoObj.DeliveryType = fields["CHANGE"];
        infoObj.HadComplications = fields["CHANGE"];
        infoObj.PregnancyComplications = fields["CHANGE"];
        infoObj.HadHospitalization = fields["CHANGE"];
        infoObj.BirthHospitalization = fields["CHANGE"];
        infoObj.NamePrimaryPhysician = fields["CHANGE"];
        infoObj.OrganizationPrimaryPhysician = fields["CHANGE"];
        infoObj.PhonePrimaryPhysician = fields["CHANGE"];
        infoObj.HospitalizationsAndMedicalProcedures = fields["CHANGE"];
        infoObj.Epilepsy/Seizures = fields["CHANGE"];
        infoObj.Diabetes = fields["CHANGE"];
        infoObj.Asthma = fields["CHANGE"];
        infoObj.UsesAnEpi = fields["CHANGE"];
    }
